...
theorem vStoreVarFP_exec (prog : ArmProg) (layout : VarLayout) (v : Var)
  ...
  | some (.freg r) =>
    -- r ≠ d0 by regConventionSafe, so code = [.fmovRR r .d0]
...
theorem vLoadVarFP_exec (prog : ArmProg) (layout : VarLayout) (v : Var) (tmp : ArmFReg)
  ...
  | some (.stack off) =>
    ...
    · simp
  | some (.freg r) =>
    -- r ≠ tmp by regConventionSafe (tmp is d0/d1/d2, r is not)
...
theorem verifiedGenInstr_correct (prog : ArmProg) (layout : VarLayout) (pcMap : Nat → Nat)
  ...
  | printFloat hinstr =>
    ...
    obtain ⟨s1, hSteps1, _, hRel1, _, hPC1, hAM1, _, _⟩ :=
  ...
  | arrStore hinstr hidx hval hbounds =>
    ...
    · -- float arrStore
      ...
      | true =>
        ...
        obtain ⟨s2, hSteps2, hFVal_2, hRel2, hRegs2eq, hPC2, hAM2, hFregs2, hStack2⟩ :=
    ...
    · -- non-float arrStore
      ...
      | true =>
        ...
        obtain ⟨s2, hSteps2, hVal_2, hRel2, _, hPC2, hAM2, hRegs2⟩ :=
...
theorem ext_backward_simulation (p : Prog) (armProg : ArmProg)
  ...
  verifiedGenInstr_correct armProg layout pcMap p pc σ am s haltLabel divLabel boundsLabel
    arrayDecls boundsSafe instr hInstr hRel instrs hSome hPC tyCtx hWT hTS hWTL hMapped cfg' hStep hCode hPcNext hAD hNCSL hNCSLBin hNCSLPrintInt hNCSLPrintFloat hNCSLPrintStr
